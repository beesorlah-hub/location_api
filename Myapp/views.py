...
#     client_ip = request.META.get('HTTP_X_FORWARDED_FOR', request.META.get('REMOTE_ADDR'))
#     try:
#         # Fetch location info based on client IP
#         geo_api_key = 'f68fe92da60348d9abe0e84512ab50c0'
#         location_response = requests.get(f'https://api.ipgeolocation.io/ipgeo?apiKey={geo_api_key}&ip={client_ip}')
#         location_response.raise_for_status()
#         location_data = location_response.json()
#         city = location_data.get('city', 'Unknown')
#         region = location_data.get('region_name', 'Unknown')
